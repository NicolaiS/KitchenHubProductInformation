...
import kr.kaist.resl.kitchenhubproductinformation.enums.EnumOnsService;
...
public class ONSUtil {
    ...
    /**
     * Get all Product information services of products
     *
     * @param context  context
     * @param products product
     * @return Map of products and their Product information services
     */
    public static Map<Product, List<NAPTRRecord>> getProductRecordMap(Context context, List<Product> products) {
        ...
        for (String fqdn : fqdnSet) {
            try {
                List<NAPTRRecord> records = ONSUtil.requestRecords(context, fqdn, EnumOnsService.PRODUCT_INFORMATION);
